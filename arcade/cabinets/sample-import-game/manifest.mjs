...
export const sampleImportManifest = Object.freeze({
  ...
  current_height: 480,
  aspect_ratio: 320 / 480,
  entry_file: 'arcade/cabinets/sample-import-game/sample-game.mjs',
  adapter_module: 'arcade/cabinets/sample-import-game/adapter.mjs',
  styles: [],
  scripts: ['arcade/cabinets/sample-import-game/sample-game.mjs'],
