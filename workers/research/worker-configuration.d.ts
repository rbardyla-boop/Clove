/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 290036ea26c9bdd76463e5a088463f86)
// Runtime types generated with workerd@1.20260801.1 2026-08-08 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	ENVIRONMENT: "internal-only";
	RESEARCH_QUESTION_VERSION: "2026-08-08";
	COST_AUTHORITY: DurableObjectNamespace /* CostAuthority from clove-research-cost-authority */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "RESEARCH_QUESTION_VERSION">> {}
}
