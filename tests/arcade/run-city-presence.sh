#!/usr/bin/env bash
# Runs the Phase 5C Live District Presence browser smoke against the local city dev shim.
...
sleep 1
set +e
BASE_URL="http://127.0.0.1:$PORT_HTTP" WS_URL="ws://127.0.0.1:$PORT_WS/arcade/city/ws" node "$ROOT/tests/arcade/city-presence.spec.mjs"
CODE=$?
set -e
