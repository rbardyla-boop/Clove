...
const PRIVATE=['digital-stewardship-02.html','digital-stewardship-02.js'];

test('DS-I2 is explicitly hard-excluded from public production',()=>{
...
test('Mission 001 remains public while DS-I0/I1/I2 remain private',()=>{
  ...
  for(const path of ['digital-stewardship-00.html','digital-stewardship-00.js','digital-stewardship-01.html','digital-stewardship-01.js',...PRIVATE]) assert.equal(included.includes(path),false,path);
});
