...
const PRIVATE=['digital-stewardship-05.html','digital-stewardship-05.js'];

test('DS-I5 files are hard-excluded from production',()=>{
  for(const file of PRIVATE) assert.equal(HARD_EXCLUDE_FILES.has(file),true,`${file} missing from hard exclusion`);
});

test('DS-I5 cannot enter public upload while Mission 001 remains public',()=>{
