...
const PRIVATE=['digital-stewardship-06.html','digital-stewardship-06.js'];

test('DS-I6 files are hard-excluded from production',()=>{
  for(const file of PRIVATE) assert.equal(HARD_EXCLUDE_FILES.has(file),true,`${file} missing from hard exclusion`);
});

test('DS-I6 cannot enter public upload while Mission 001 remains public',()=>{
