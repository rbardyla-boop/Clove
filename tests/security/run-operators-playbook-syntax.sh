#!/usr/bin/env bash
# Regression runner — operators-playbook.html inline-script syntax.
# Serves the repo root over a local static server and runs the syntax spec.
...
sleep 1
set +e
node "$ROOT/tests/security/operators-playbook-syntax.spec.mjs"
CODE=$?
set -e
